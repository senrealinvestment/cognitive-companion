...
Wake word / button; never auto; soft glyph from System One. Latency local deep: **estimate 5–30 s** depending on retrieval+gen (**labeled estimate**). Output: panel+citations primary; optional MedGemma one-liner + wording check.
